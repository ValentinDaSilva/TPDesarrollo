...
public abstract class EstadoEstadia {
    ...
    /**
     * Intenta agregar un huésped a la estadía.
     * Por defecto lanza excepción si no es posible.
     */
    public void agregarHuesped(Estadia estadia, Huesped huesped) {
        throw new NegocioException(
            "No se puede agregar huésped en estado " + getNombre()
        );
    }

    /**
     * Intenta agregar un servicio extra a la estadía.
     * Por defecto lanza excepción si no es posible.
     */
    public void agregarServicioExtra(Estadia estadia, ServicioExtra servicio) {
        throw new NegocioException(
            "No se puede agregar servicio extra en estado " + getNombre()
        );
    }

    /**
     * Intenta generar una factura para la estadía.
     * Por defecto lanza excepción si no es posible.
     */
    public void generarFactura(Estadia estadia, Factura factura) {
        throw new NegocioException(
            "No se puede generar una factura para una estadía en estado " + getNombre()
        );
    }

    /**
     * Intenta modificar las fechas de la estadía.
     * Por defecto lanza excepción si no es posible.
     */
    public void modificarFechas(
        ...
        throw new NegocioException(
            "No se pueden modificar fechas en estado " + getNombre()
        );
    }
    ...
    public void finalizar(Estadia estadia) {
        throw new NegocioException(
            "No se puede finalizar en estado " + getNombre()
        );
    }
}
