...
public class Reserva {
    ...
    public void mostrarReserva() {
        ...
        if (habitacion != null) {
            System.out.println("Habitación N°   : " + habitacion.getNumero());
        } else {
            System.out.println("Habitación N°   : SIN HABITACIÓN ASIGNADA");
        }

        if (estadia != null) {
            System.out.println("Estadía ID      : " + estadia.getId_estadia());
            System.out.println("Estado estadía  : " + estadia.getEstado());
        } else {
            System.out.println("Estadía         : NO CREADA");
        }
