...
public interface ClassMapper {
    ...
    @Mappings({
        ...
        @Mapping(target = "listafactura", ignore = true),
        @Mapping(target = "reserva", ignore = true),
        @Mapping(target = "estadoEstadia", ignore = true) // 🔥 State (transient)
    })
    ...
    @Mappings({
        ...
        @Mapping(target = "estadoReserva", ignore = true) // 🔥 State (transient)
    })
    ...
    @Mappings({
        ...
        @Mapping(target = "responsablePago", ignore = true),
        @Mapping(target = "estadoFactura", ignore = true) // 🔥 State (transient)
    })
    ...
    @Mappings({
        ...
        // 🔥 Campos SOLO de cálculo / frontend
        @Mapping(target = "consumosIds", ignore = true),
        @Mapping(target = "fechaHoraCheckoutReal", ignore = true),
