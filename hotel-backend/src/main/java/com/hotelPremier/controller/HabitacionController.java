...
public class HabitacionController {
    ...
    public ResponseEntity<List<HabitacionDTO>> getHabitaciones(
        ...
        // Convertir a mayúsculas antes de buscar
        String tipoNormalizado = tipo.toUpperCase();

        return ResponseEntity.ok(habitacionService.getHabitaciones(tipoNormalizado));
    }
    @Operation(summary = "Listar habitaciones en total")
    @GetMapping("/listarHabitaciones")
    public ResponseEntity<List<HabitacionDTO>> getHabitacionesAll(){
